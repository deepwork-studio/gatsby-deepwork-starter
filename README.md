...
<h1 align="center">
  Deep Work Studio × Gatsby Starter
</h1>
...
1.  **Open the source code and start editing!**
    ...
    Open the `my-deepwork-starter` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/deepwork-studio/gatsby-deepwork-starter)
